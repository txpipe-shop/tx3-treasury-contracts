...
export async function deployTransaction<P extends Provider, W extends Wallet>(blazeInstance: Blaze<P, W>, scripts: Script[]): Promise<Transaction> {
    let txBuilder = blazeInstance.newTransaction();
